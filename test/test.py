...
class YoudaoNotePullTest(unittest.TestCase):
    ...
    def test_covert_config_json(self):
        ...
        config_json_str = """
            ...
            """
        with patch(
            "builtins.open", mock_open(read_data=config_json_str.encode("utf-8"))
        ):
            config_dict, error_msg = youdaonote_pull._covert_config(
    ...
    def test_get_dir_id(self):
        ...
        youdaonote_api.http_post = Mock(
            return_value=MockResponse(return_value_json, 200)
        )
